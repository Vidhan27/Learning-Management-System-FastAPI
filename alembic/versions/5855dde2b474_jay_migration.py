...
Revision ID: 5855dde2b474
Revises: 
Create Date: 2024-07-07 21:04:09.425988
...
def upgrade() :
    ...
    op.add_column(
        'users',sa.Column('role', sa.Enum('teacher', 'student', name='role'), nullable=True),
    )
    ...
    op.add_column(
        'content_blocks', sa.Column('type', sa.Enum('lesson', 'quiz', 'assignment', name='contenttype'), nullable=True),
    )
